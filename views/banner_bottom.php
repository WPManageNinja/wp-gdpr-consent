<div style='position:fixed; bottom:0px; width:100%; background:<?php echo $background;?>; color:<?php echo $color;?>; z-index:99999; padding:10px;' id='wpgdpr_banner_bottom'>
    <p style='margin-left:20px; display:inline; position:relative; top:12px; color:<?php echo $color_msg ?>;'><?php echo $ConfigDatas['message'];?></p>
    <?php if($link): ?>
        <a href="<?php echo esc_url($link);?>" target='_blank' style='display:inline; position:relative; top:12px; font-size:16px; color:#A2A1A1; margin-left:8px;'>
