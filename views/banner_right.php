<div style='border-radius:10px; position:fixed; width: 25%; padding: 27px; bottom: 17px; right: 12px; background:<?php echo $background; ?>; color:<?php echo $color; ?>; z-index: 99999; margin-right: 9px;' id='wpgdpr_banner_right'>
